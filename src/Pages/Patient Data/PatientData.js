...
const MyTask = () => {
    ...
    const { data: taskManagement = [], refetch, isLoading } = useQuery({
        ...
        queryFn: async () => {
            const res = await fetch('https://task-manager-server-theta.vercel.app/taskManagement');
    ...
    const handleTaskDelete = task => {
        fetch(`https://task-manager-server-theta.vercel.app/taskManagement/${task._id}`, {
            method: 'DELETE'
        })
            .then(res => res.json())
            .then(data => {
    ...
    const handleTaskComplated = id => {
        fetch(`https://task-manager-server-theta.vercel.app/taskManagement/complated/${id}`, {
            method: 'PUT'
        })
            .then(res => res.json())
            .then(data => {
