...
// import image from '../../image/blog3'
const Details = () => {
    const detailsStrodData = useLoaderData();
    console.log(detailsStrodData);
    const { taskDescription, taskTitle, startDate, email, taskWork, _id } = detailsStrodData;
    return (
        <div>
            <section className="m-4 md:m-8 dark:bg-gray-800 dark:text-gray-100">
                ...
                <div className="container mx-auto grid justify-center gap-4 sm:grid-cols-2 lg:grid-cols-3">
                    <div className="flex flex-col items-center p-4">
                        ...
                        <h3 className="my-3 text-3xl font-semibold">Patient ID</h3>
                    ...
                    <div className="flex flex-col items-center p-4">
                        ...
                        <h3 className="my-3 text-3xl font-semibold">Disease</h3>
                        <div className="space-y-1 leading-tight">
                    ...
                    <div className="flex flex-col items-center p-4">
                        ...
                        <h3 className="my-3 text-3xl font-semibold"> Date</h3>
                        <div className="space-y-1 leading-tight">
                ...
                <div className="container flex flex-col-reverse mx-auto lg:flex-row">
                    <div className="flex flex-col px-6 py-8 space-y-6 rounded-sm sm:p-8 lg:p-12 lg:w-1/2 xl:w-2/5 dark:bg-violet-400 dark:text-gray-900">
                        <div className="flex space-x-2 sm:space-x-4">
                            ...
                            <div className="space-y-2">
                                <p className="text-lg font-medium leading-snug text-green-500">Details</p>
                    ...
                    <div className="lg:w-1/2 xl:w-3/5 dark:bg-gray-800">
                        <div className="flex items-center justify-center p-4 md:p-8 lg:p-12">
                            <img src="https://images.pexels.com/photos/2324837/pexels-photo-2324837.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="" className="rounded-lg shadow-lg dark:bg-gray-500 aspect-video sm:min-h-96" />
                        </div>
                    </div>
                </div>
            </section>
